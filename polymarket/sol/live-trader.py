...
CHAIN_ID = 137
CHAINLINK_FEED = "0x0003b778d3f6b2ac4991302b89cb313f99a42467d6c9c5f96f57c29c0d2bc24f"
...
def get_chainlink_price(at_timestamp=None):
    """Get SOL price from Chainlink. If at_timestamp given, find closest price to that time."""
    try:
...
def resolve_all():
    ...
    Phase 1 (Chainlink, ~30s): Compare SOL price to strike for immediate resolution.
