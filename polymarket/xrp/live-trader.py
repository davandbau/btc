...
CHAIN_ID = 137
CHAINLINK_FEED = "0x0003c16c6aed42294f5cb4741f6e59ba2d728f0eae2eb9e6d3f555808c59fc45"
...
def get_chainlink_price(at_timestamp=None):
    """Get XRP price from Chainlink. If at_timestamp given, find closest price to that time."""
    try:
...
def resolve_all():
    ...
    Phase 1 (Chainlink, ~30s): Compare XRP price to strike for immediate resolution.
